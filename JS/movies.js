function displayMovies(movies) {
    ...
    movies.forEach(movie => {
        let card = document.createElement('div')
            ...
            card.classList = 'w-[250px] bg-[#003049] rounded-t-lg rounded-b-lg drop-shadow-md flex flex-col align-center hover:scale-105 transition-all hover:drop-shadow-[0_0_4px_#fefae0]'
